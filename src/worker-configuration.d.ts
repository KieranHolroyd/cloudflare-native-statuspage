/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: bc3b3dfc4c4db48a04363df100e2e34f)
// Runtime types generated with workerd@1.20260903.1 2026-09-01 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	statuspage_db: D1Database;
	ASSETS: Fetcher;
	BETTER_AUTH_SECRET: string;
	STATUS_CHANNEL: DurableObjectNamespace<import("./worker").StatusChannel>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "StatusChannel";
	}
